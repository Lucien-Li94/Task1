...
config_isolation = {
    'sign':'۩',
    'enable': False, # whether the settings below are enabled.
    ...
    'notificationRate': 0.8, # 80% notification success ratio
    'agreeIsolationRate': 0.9, # only 90% people follow the self-isolation rule
    'selfDiscipline': 0.9, # when people are isolated, they only reduce 90% activates
}
...
config_preventions = {
    ...
    'mask': {
        'sign':'M',
        'applicationRatio': 0, # 0% people wearing mask
