...
config_isolation = {
    ...
    'notificationRate': 0.4, # 40% notification success ratio
...
config_preventions = {
    ...
    'mask': {
        'sign':'M',
        'applicationRatio': 0.4, # 90% people wearing mask
    ...
    'touchOften': {
        'sign':'ᕗ',
        'applicationRatio': 0.3, # nobody adopt this method
        'aerosolSpreading': 1, # 100% virus spreading to aerosol
